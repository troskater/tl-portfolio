export default function About() {
  return (
    <div className="about">
      <section>
        <div className="img-flex-2 img desktop-only">
          <span style={{
        ...
        <div className="text">
          ...
          <div className="img-flex-2 img mobile-only">
            <span style={{
              background: "url('img/PXL_20231127_214820021.jpg') lightgray 50% / cover no-repeat"
            }}></span>
            <span style={{
      ...
      <section>
        <div className="text">
          ...
          <div className="img mobile-only" style={{
        ...
        <div className="img desktop-only" style={{
          background: "url('img/PXL_20231211_224952055.jpg') lightgray 50% / cover no-repeat"
        }}>
        </div>
      </section>
